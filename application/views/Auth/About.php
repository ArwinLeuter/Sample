...
<html lang="en">
  <head>
    ...
    <title>About Page | <?php echo $sess?></title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/about');?>"><span style="color: red;">A</span> B O U T</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/about');?>"><span style="color: red;">A</span></a>
        </div>
        <ul class="nav">
      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            <img src="<?php echo base_url('assets/template/assets/images/logologo.jpg');?>" alt="avatar"
              class="rounded-circle img-fluid" style="width: 150px;">
            <h5 class="my-3"><?php echo $sess?></h5>
