...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/index1');?>"><span style="color: red;">D</span>E L E T E</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/english');?>"><span style="color: red;">D</span></a>
        </div>
        <ul class="nav">
    ...
    <table class="table mt-5 table-hover text-center" >
                          ...
                          <tbody >
                          <?php foreach ($delete_logs as $log): ?>
        <tr>
            <td><?php echo $log->deleted_by; ?></td>
            <td><?php echo $log->deleted_at; ?></td>
            <td><button class="btn btn-success" >Retrieve</button></td>
