      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="card corona-gradient-card" style="max-height: 450px; overflow: auto;">
                <div class="card-body py-0 px-0 px-sm-3">
                      <?php foreach($result as $row) {?>
                        <div style="">
                      <p style="padding-top: 10px;"><img class="img-xs rounded-circle" src="<?php echo base_url('assets/template/assets/images/logologo.jpg');?>" alt="">
                      <b style="padding-left: 10px;"><i><?php echo $row['user_id']?></i> :</b><span style="color: black;"><?php echo $row['groupMessage']?></span></p>
                      <br>
                      </div>
                      <?php }?>
                        <br>
                ...
                <textarea style="float: left; width: 93%; height: 30px; background-color: black; border-radius: 5px; color: white;" name="message"> </textarea>
                <input type="Submit" value="send" class="btn btn-success"  name="" style="margin-left: 5px; color: black;">
        </p>
                </div>
