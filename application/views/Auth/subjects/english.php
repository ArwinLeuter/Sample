    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/index1');?>"><span style="color: red;">E</span> N G L I S H</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/english');?>"><span style="color: red;">E</span></a>
        </div>
        <ul class="nav">
                                ...
                                <div class="btn-group">
                                   <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu p-2">
                                      <?php if($admin_level == "admin") {?>  
                                    <li><a href="<?php echo base_url('index.php/addenglish/getDetails/' .$row['book_id'])?>" class="btn btn-success mdi mdi-pencil-box-outline mb-1" data-toggle="tooltip" data-placement="top" title="Update Info"></a><span style="margin-left: 10px;">Update Info</span></li>
                                    <li><a href="<?php echo base_url('index.php/updatefunctions/getFile/' .$row['book_id'])?>" class="btn btn-info mdi mdi-pencil-box-outline mb-1" data-toggle="tooltip" data-placement="top" title="Update File"></a><span style="margin-left: 10px;">Update File</span></li>
                                    ...
                                    <?php }else{?>
                                      <?php }?>
                                      <li><a href="<?php echo base_url('/viewing_controller/viewData/' .$row['book_id']); ?>" target="_blank" method="post" class="btn btn-warning mdi mdi-eye   mb-1" data-toggle="tooltip" data-placement="top" title="View"></a><span style="margin-left: 10px;">View</span></li>
                                    <li><a href="<?php echo site_url('download_controller/download_file/'.$row['files']); ?>" class="btn btn-primary mdi mdi-download mb-1" data-toggle="tooltip" data-placement="top" title="Download Files"></a><span style="margin-left: 10px;">Download</span></li>
                                    <li></li>
                                  </ul>
                                </div>
