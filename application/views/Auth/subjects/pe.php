    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/pe');?>"><span style="color: red;">P</span> E</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/pe');?>"><span style="color: red;">P</span></a>
        </div>
        <ul class="nav">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              ...
              <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" method="post" action="<?= base_url('index.php/Auth/search_keyword5/');?>">
        ...
        <div class="container bg-black" style="padding-top: 80px;">
                          <div class="container">
    <h2>Physical Education Module</h2>
                              ...
                              <div class="btn-group">
                                   <button type="button" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    ...
                                    <ul class="dropdown-menu p-2">
                                      <?php if($admin_level == "admin") {?>  
                                    <li><a href="<?php echo base_url('index.php/addpe/getDetails5/' .$row['book_id'])?>" class="btn btn-success mdi mdi-pencil-box-outline mb-1" data-toggle="tooltip" data-placement="top" title="Update Info"></a><span style="margin-left: 10px;">Update Info</span></li>
                                    <li><a href="<?php echo base_url('index.php/updatefunctions/getFile5/' .$row['book_id'])?>" class="btn btn-info mdi mdi-pencil-box-outline mb-1" data-toggle="tooltip" data-placement="top" title="Update File"></a><span style="margin-left: 10px;">Update File</span></li>
                                    <li><a href="<?php echo base_url('index.php/addenglish/delete/' .$row['book_id']); ?>" method="post" class="btn btn-danger mdi mdi-delete-forever mb-1" data-toggle="tooltip" data-placement="top" title="Delete" onclick= "return confirm ('Are you sure?')" ></a><span style="margin-left: 10px;">Delete</span></li>
                                    <?php }else{?>
                                      <?php }?>
                                      <li><a href="<?php echo base_url('/viewing_controller/viewData5/' .$row['book_id']); ?>" target="_blank" method="post" class="btn btn-warning mdi mdi-eye   mb-1" data-toggle="tooltip" data-placement="top" title="View"></a><span style="margin-left: 10px;">View</span></li>
                                    <li><a href="<?php echo site_url('download_controller/download_file5/'.$row['files']); ?>" class="btn btn-primary mdi mdi-download mb-1" data-toggle="tooltip" data-placement="top" title="Download Files"></a><span style="margin-left: 10px;">Download</span></li>
                                    <li></li>
                                  </ul>
                                </div>
                            </td>
              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <h3 class="text-center mb-3">Physical Education</h3>

                    <form action="<?php echo base_url('index.php/addpe/insertPe') ?>" method="POST" class="p-3" enctype="multipart/form-data">
                      <div class="form-group row">
