    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="http://localhost/sample/Auth/Display_message"><span style="color: red;">M</span> E S S A G E S</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="http://localhost/sample/Auth/Display_message"><span style="color: red;">M</span></a>
        </div>
        <ul class="nav">
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
              <h1 style="color: white;">Arwin Leuter Pogi</h1>
              
              <form action="<?php echo base_url('index.php/Auth/uploadProcess');?>" method="post" enctype="multipart/form-data">
              ...
              <?php foreach($result as $row) { ?>
                <img src="<?php echo base_url('sample/uploaded_files/'.$row['uploaded_file']);?>" alt="files"  class="card-img-top" object-fit="cover" height="200">
              <?php } ?>
        </div>
            
        </div>

        <!-- If you are using CodeIgniter to upload images but they are not displaying properly, it could be due to a few different reasons. Here are some steps you can take to troubleshoot the issue:

Check the file permissions: Make sure that the image files you uploaded have the correct permissions. They should be readable by the web server.

Check the file path: Verify that the file path is correct and that the images are stored in the correct directory.

Check the HTML code: Ensure that the HTML code used to display the images is correct. Make sure that the image source attribute points to the correct file path.

Check the image format: Check that the image file format is supported by the browser. You can do this by trying to display the image in a different browser or by converting the image to a different format.

Check the image size: Make sure that the image size is not too large. If the image is too large, it may not be able to be displayed properly.

Check for errors: Check the server logs and CodeIgniter error logs for any error messages related to the image uploading or displaying process.

By following these steps, you should be able to diagnose and fix the issue with your images not displaying properly in CodeIgniter.
