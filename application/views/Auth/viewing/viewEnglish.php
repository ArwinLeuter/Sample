...
<html lang="en">
  ...
  <body>
    ...
    <a href="<?php echo site_url('download_controller/download_file/'.$record['files']); ?>" class="btn btn-primary mdi mdi-download mb-1" data-toggle="tooltip" data-placement="top" title="Download Files"></a><span style="margin-left: 10px; ">Download</span>
