...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/index1');?>"><span style="color: red;">F</span> I L I P I N O</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/english');?>"><span style="color: red;">F</span></a>
        </div>
        <ul class="nav">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav w-100">
              <li class="nav-item w-100">
                <form action="<?php echo site_url('index.php/searchcontroller/search_keyword/')?>" class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
    ...
    <div class="container bg-black" style="padding-top: 80px; padding-left: 300px" >
     <div class="container">
    <h2>Filipino Module Info</h2>
    

    <div style="float: left; padding-left: 0px; padding-top: 50px;">
    <div role="tabpanel" class="tab-pane active" id="title">
        <h3 class="text-success">Title: <u class="text-light"><?php echo $record['title']; ?></u></h3>
    </div>
    <div role="tabpanel" class="tab-pane active" id="authors">
        <h3 class="text-success">Authors: <u class="text-light"><?php echo $record['authors']; ?></u></h3>
    </div>
    <div role="tabpanel" class="tab-pane active" id="date">
        <h3 class="text-success">Date: <u class="text-light"><?php echo $record['date']; ?></u></h3>
    </div>
    <div role="tabpanel" class="tab-pane active" id="date">
        <h3 class="text-success">Filename: <u class="text-light"><?php echo $record['files']; ?></u></h3>
        

    </div>
    <a href="<?php echo site_url('download_controller/download_file3/'.$record['files']); ?>" class="btn btn-primary mdi mdi-download mb-1" data-toggle="tooltip" data-placement="top" title="Download Files"></a><span style="margin-left: 10px; ">Download</span>
