...
<html lang="en">
  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/index1');?>"><span style="color: red;">M</span> A T H</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/english');?>"><span style="color: red;">M</span></a>
        </div>
        <ul class="nav">
    ...
    <a href="<?php echo site_url('download_controller/download_file1/'.$record['files']); ?>" class="btn btn-primary mdi mdi-download mb-1" data-toggle="tooltip" data-placement="top" title="Download Files"></a><span style="margin-left: 10px; ">Download</span>
