              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <h3 class="text-center mb-3">Araling Panlipunan File Update </h3>

                    <form method="post" action="<?php echo site_url('updatefunctions/apfileupdate');?>" enctype="multipart/form-data">
    <input type="hidden" name="book_id" value="<?php echo $result['book_id']; ?>">
    <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label"></label>
    <div class="col-sm-10">
        <?php if (!empty($result['files'])) { ?>
            <p>Current File: <a href="<?php echo base_url().'uploads/ap/'.$result['files']; ?>"><?php echo $result['files']; ?></a></p>
        <?php } ?>
