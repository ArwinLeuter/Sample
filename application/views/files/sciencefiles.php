...
<html lang="en">
  <head>
    ...
    <title>Science | Update Form</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/acience');?>"><span style="color: red;">S</span> C I E N C E</a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/acience');?>"><span style="color: red;">S</span></a>
        </div>
        <ul class="nav">
              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <h3 class="text-center mb-3">Science File Update </h3>

                    <form method="post" action="<?php echo site_url('updatefunctions/sciencefileupdate');?>" enctype="multipart/form-data">
    <input type="hidden" name="book_id" value="<?php echo $result['book_id']; ?>">
    <div class="form-group row">
    <label for="staticEmail" class="col-sm-2 col-form-label"></label>
    <div class="col-sm-10">
        <?php if (!empty($result['files'])) { ?>
            <p>Current File: <a href="<?php echo base_url().'uploads/science/'.$result['files']; ?>"><?php echo $result['files']; ?></a></p>
        <?php } ?>
        ...
        <div style="float: right; padding-right: 100px;">
            ...
            <button type="button" class="btn btn-primary"><a href="<?php echo base_url('Auth/science');?>" style="text-decoration: none; color: white;">Cancel</a></button>
        </div>
    </div>
</div>
