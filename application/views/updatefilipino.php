    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">  
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/filipino');?>"><span style="color: red;">F</span> I L P I N O</a>
              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <form action="<?php echo base_url('index.php/addfilipino/filipinoupdate') ?>" method="POST" class="p-3">
                      <div class="form-group row">
