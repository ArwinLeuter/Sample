    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
          <a class="sidebar-brand brand-logo" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/math');?>"><span style="color: red;">M</span> A T H </a>
          <a class="sidebar-brand brand-logo-mini" style="text-decoration:none; font-size: 30px;" href="<?php echo base_url('Auth/math');?>"><span style="color: red;">M</span></a>
        </div>
        <ul class="nav">
              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <form action="<?php echo base_url('index.php/addmath/mathupdate') ?>" method="POST" class="p-3">
                      <div class="form-group row">
