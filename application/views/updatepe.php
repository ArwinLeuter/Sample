              ...
              <div class="col">
                <div class="form-outline">
                  <div class="form-group row">
                    ...
                    <form action="<?php echo base_url('index.php/addpe/peupdate') ?>" method="POST" class="p-3">
                      <div class="form-group row">
                      ...
                      <div style="float: right;">
                         ...
                         <button type="button" class="btn btn-primary"><a href="<?php echo base_url('Auth/pe');?>" style="text-decoration: none; color: white;">Cancel</a></button>
                      </div>
